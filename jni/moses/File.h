...
#else
//#define OFF_T off_t  // mgjang need to check
#define OFF_T loff_t  // mgjang need to check
//#define OFF_T off64_t  // mgjang need to check
#define FTELLO(f) ftello(f)
//#define FTELLO(f) _ftello64(f)
#define FSEEKO(file, offset, origin) fseeko(file, offset, origin)
//#define FSEEKO(file, offset, origin) _fseeko64(file, offset, origin)
#endif

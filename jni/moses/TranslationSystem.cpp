...
namespace Moses {
  ...
  const string TranslationSystem::DEFAULT = "default";
    ...
    void TranslationSystem::InitializeBeforeSentenceProcessing(const InputType& source) const {
		LOGE("[mgjang] in InitializeBeforeSentenceProcessing function \n");
	...
	LOGE("[mgjang] 1 in InitializeBeforeSentenceProcessing function \n");           
      for(size_t i=0;i<m_reorderingTables.size();++i) {
        m_reorderingTables[i]->InitializeForInput(source);
      }
	  LOGE("[mgjang] 2 in InitializeBeforeSentenceProcessing function \n"); 		  
      ...
      //}
	LOGE("[mgjang] 3 in InitializeBeforeSentenceProcessing function \n");                 
	...
	LOGE("[mgjang] 4 in InitializeBeforeSentenceProcessing function \n");                 
	...
	LOGE("[mgjang] 5 in InitializeBeforeSentenceProcessing function \n");           	  
    }

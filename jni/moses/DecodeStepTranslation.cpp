...
LOGE("[mgjang] in ProcessInitialTranslation function\n");
  ...
  {
	  LOGA("[mgjang] phraseColl is null \n");
  }
  LOGE("[mgjang] end of ProcessInitialTranslation function\n");
}
